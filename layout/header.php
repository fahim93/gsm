...
<meta name="og:image" content="<?=BASE_URL?>uploads/system/l1574162894.png">
...
<title>Home Page | GSM Tech Master</title>
<!-- 'theam_color','theme_text','top_bar','folder','manu_bar','footer_color','' -->

<style>
    :root {
        --main-bg-color: #33BD25;
        /* theamecolor */
        --main-ft-color: #101010;
        --main-folder-color: #101010;
        --title-nav: #33BD25;
        --top-bar: #222;
        --top-bar-header: #222;
        --top-bar-menu: #222;
