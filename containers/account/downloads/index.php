        ...
        <div class="col-md-9 col-sm-12 col-xs-12 no-padding no-margin">
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <h2 class="border mar-b-30"><i class="fa fa-caret-right fw-r10"></i>Downloads History</h2>
                </div>

                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="form-control" id="filter_upackage_id">
                        <option value="">All upackages</option>
                        <option value="1">Free [20-Sep-2020]</option>
                    </select>
                </div>
            </div>
            <div class="row">
